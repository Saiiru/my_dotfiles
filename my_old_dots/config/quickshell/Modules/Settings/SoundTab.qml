            ...
            Row {
                ...
                CachingImage {
                    ...
                    source: {
                        ...
                        const fallback = pwIcon && soundTab.iconFallbacks[pwIcon] ? soundTab.iconFallbacks[pwIcon] : ""
                        fallbackIconName = fallback || ""
                        return fallback ? "" : (pwIcon && pwIcon !== "" ? `image://icon/${pwIcon}` : "")
                    }
                    fillMode: Image.PreserveAspectFit
                    visible: source !== "" || fallbackIconName !== ""
                ...
                DankIcon {
                    ...
                    name: appIcon.fallbackIconName
                    visible: appIcon.fallbackIconName !== ""
                }
    ...
    Component {
        ...
        StyledRect {
            ...
            Row {
                ...
                DankIcon {
                    anchors.centerIn: routeIcon
                    size: (Theme.iconSize || 24)
                    name: routeIcon.fallbackIconName
                    visible: routeIcon.fallbackIconName !== ""
                }
