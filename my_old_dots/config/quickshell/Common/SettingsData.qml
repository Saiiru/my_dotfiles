...
Singleton {
    ...
    FontLoader {
        id: interVariableLoader
        source: Qt.resolvedUrl("../assets/fonts/inter/InterVariable.ttf")
    }

    FontLoader {
        id: materialSymbolsRoundedLoader
        source: Qt.resolvedUrl("../assets/fonts/material-design-icons/variablefont/MaterialSymbolsRounded[FILL,GRAD,opsz,wght].ttf")
    }

    FontLoader {
        id: materialSymbolsOutlinedLoader
        source: Qt.resolvedUrl("../assets/fonts/material-design-icons/variablefont/MaterialSymbolsOutlined[FILL,GRAD,opsz,wght].ttf")
    }

    readonly property string interFontFamily: interVariableLoader.status === FontLoader.Ready ? interVariableLoader.name : "Inter Variable"
    readonly property string materialSymbolsRoundedFamily: materialSymbolsRoundedLoader.status === FontLoader.Ready ? materialSymbolsRoundedLoader.name : "Material Symbols Rounded"
    readonly property string materialSymbolsOutlinedFamily: materialSymbolsOutlinedLoader.status === FontLoader.Ready ? materialSymbolsOutlinedLoader.name : "Material Symbols Outlined"
    ...
    property string fontFamily: interFontFamily
    ...
    readonly property string defaultFontFamily: interFontFamily
