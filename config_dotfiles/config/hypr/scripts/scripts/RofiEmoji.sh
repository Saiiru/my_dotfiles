...
# Assuming iDIR is defined or can be derived for notify-send icon
...
if [[ -n "$selected_emoji" ]]; then
    echo "$selected_emoji" | wl-copy
    notify-send -e -u low -i "$iDIR/ja.png" "Emoji Copied" "'$selected_emoji' copied to clipboard."
fi
