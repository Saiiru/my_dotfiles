-- Custom lualine (Eviline-style) tuned for transparent cyberdream/Batman palette
-- Colors and layout adapted from shadmansaleh/glepnir config, with tweaks for LSP + git
local colors = {
  bg       = "NONE",
  fg       = "#bbc2cf",
  yellow   = "#ECBE7B",
