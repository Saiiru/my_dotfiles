...
local system_paste_opts = { desc = "General | Paste system clipboard", silent = true }
vim.keymap.set({ "n", "x" }, "<C-v>", '"+P', system_paste_opts)
vim.keymap.set("i", "<C-v>", '<C-r><C-o>+', system_paste_opts)
vim.keymap.set({ "n", "x" }, "<S-Insert>", '"+P', system_paste_opts)
vim.keymap.set("i", "<S-Insert>", '<C-r><C-o>+', system_paste_opts)
...
vim.keymap.set("n", "<leader>ut", function()
  vim.cmd "NeoTransparent"
end, { desc = "Theme | Toggle Transparency", silent = true })
